# 09. 데이터 분석 프로젝트 2017 년도 시작하겠습다니다
...
#데이터 준비하기
raw_welfare <- read.spss(file = "Koweps_hpda12_2017_beta1.sav", to.data.frame = T) #데이터 불러오기
...
qplot(welfare$group_marriage)#그래프
...
#2017년도 데이터 분석 프로젝트 (한국인 삶을 파악하라) 끝. 봐주셔서 감사합니다.